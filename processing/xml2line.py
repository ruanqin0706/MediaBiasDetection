...
import argparse
from processing import utils, features, processingresources
...
if __name__ == "__main__":
    ...
    parser.add_argument("-F", default=default_F,
                        help="Feature list to use, or comma separated list of features ({})".format(default_F))
